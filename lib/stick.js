...
exports.Application = function Application() {
    ...
    Object.defineProperty(app, "configure", {
        value: function(env, components) {
            ...
            // prepend to existing middleware stack or a proxy to the default stack
            var chain = middleware[env] || defaultStackProxy;
    ...
    var defaultStackProxy = function(req) {
        return middleware._default_(req)
    };

    defaultStackProxy.toString = function() {
        return "_default_";
    };
