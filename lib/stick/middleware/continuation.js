 ...
 * response. This method tells the middleware to store the generator in the user's
 * session and returns a contination id. For subsequent invocations of the generator,
 * the continuation id has to be set as query string parameter with name `_c`.
 *
 * When suspended generator is resumed, the new request object is passed in as value for
